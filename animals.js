...
var animalTypes = {
    ...
    'emperorPenguin': createAnimalType({'single': 'emperor penguin', 'plural': 'emperor penguins',
                                    'health': 30, 'healthGrowth': 5, 'speed': 10, 'speedGrowth': 0,
                                    'armor': 2, 'armorGrowth': .2, 'carry': 3, 'carryGrowth': 0,
                                    'damage': 1, 'damageGrowth': .2, tags: ['bird'], 'spriteIndex': 1}),
